...
public class TestTableCfg
{
	...
	public TestTableCfg(string line)
	{
...
public class TestTableCfgManager
{
	private Dictionary<int, TestTableCfg> mDict = new Dictionary<int, TestTableCfg>();
	...
	public void InitTable()
	{
		...
		foreach (string split in splits)
		{
			...
			if (line.Length > 0)
			{
				TestTableCfg rowdata = new TestTableCfg(line);
	...
	public TestTableCfg GetDataByID(int id)
	{
		TestTableCfg rowdata = null;
		mDict.TryGetValue(id, out rowdata);
		return rowdata;
	}

	private TestTableCfgManager() { }

	public static readonly TestTableCfgManager Instance = new TestTableCfgManager();
}
